...
public static class DHWebHelper
{
    ...
    public static void SaveAs(this IFormFile file, String filename, Int32 Length)
    {
        ...
        file.CopyTo(fs);
        // 获取文件现在的大小并减去4字节
        var updatedFileSize = fs.Length - Length;
    ...
    public static void SaveAs(this IFormFile file, String filename, Int64 startPosition, Int32 length)
    {
        ...
        // 开始读取
        _ = sourceStream.Read(buffer, 0, length);
    ...
    public static Uri? AsUri(this String url, Uri? baseUri = null)
    {
        ...
        // 相对路径
        return baseUri == null ? throw new ArgumentNullException(nameof(baseUri)) : new Uri(baseUri, url);
    }
    ...
    public static Boolean ValidRobot(Microsoft.AspNetCore.Http.HttpContext ctx, UserAgentParser ua)
    {
        ...
        // 判断爬虫
        var code = PekSysSetting.Current.RobotError;
